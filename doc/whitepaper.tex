...
This makes Sia filesystem agnostic - you store information on Sia by setting and requesting arrays of bits.
...
Storage on Sia is random-access, meaning that any set of bits can be requested without needing to download an entire file.
