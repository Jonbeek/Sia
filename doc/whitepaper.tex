...
Sia is a cryptosystem that is secure with only a simple majority honest hosts.
...
To make sure that hosts can be fined, they are required to have a balance equal to or greater than the maximum possible fine - a 'deductible'.
When a host leaves the network, the deductible will be released.
...
Even controlling half of the hosts on the network, an attacker has a minimal chance of controlling more than \maxcorruption{} of the hosts in a particular blockchain, as shown in the equation below:
